...
A **seam** is the public boundary you test at (`codebase-design-plus` holds the full deep-module vocabulary). Test only at seams agreed with the user; the highest seam that can observe the behavior, and as few seams as possible.
