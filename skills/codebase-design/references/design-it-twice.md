...
After comparing, give your own recommendation — via `AskUserQuestion` with the designs as options, your pick first and marked recommended, each option's description carrying its core trade-off. If elements from different designs would combine well, propose a hybrid as its own option. Be opinionated — the user wants a strong read, not a menu.
